...
writeRaster( catB, file='Bathy_cuts_MultibLidar100.tif', overwrite=TRUE)
...
Bathy.targetProps2 <- c(0.33,0.33,0.33)
...
writeRaster( inclProbs, file='inclProbs_design3.tif', overwrite=TRUE)
