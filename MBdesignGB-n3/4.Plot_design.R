...
pdf( "~/MBHdesignGB/outputs/SampleDesign_zones1.pdf")
...
pdf( "~/MBHdesignGB/outputs/SampleDesign_total1.pdf", height=7, width=8)
plot( gb_rasters$bathy, main = "Geographe Bay Clustered Transects")
